...
const T = {
  ...
  border: { default: "#D4D4D8", hover: "#B8B8BD", subtle: "#EEEEF0", dashed: "#C4C4C8", strong: "#909098" },
  text: { primary: "#111111", secondary: "#3A3A3A", muted: "#6B6B6B", ghost: "#9A9A9A", inverse: "#FFFFFF" },
  blue: { gradient: "linear-gradient(135deg, #4DABF7 0%, #1A73E8 60%, #1558B0 100%)", to: "#1A73E8" },
  black: "#111111", error: "#DC3545",
...
export default function App() {
  ...
  return (
    <div style={S.root}>
      <style>{`
        @import url('https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600&family=JetBrains+Mono:wght@400;500&family=Noto+Sans+KR:wght@300;400;500;600;800;900&family=Noto+Sans:wght@300;400;500;600;800;900&display=swap');
        ...
        @keyframes uploadSlide{from{width:0%}to{width:100%}}
        *{box-sizing:border-box;margin:0;padding:0}
        input:focus,textarea:focus{border-color:${T.blue.to}!important;outline:none;box-shadow:0 0 0 3px rgba(26,115,232,0.1)}
        button{transition:all 150ms ease;cursor:pointer}button:hover{opacity:0.82}
        ::placeholder{color:#D5D5D8;opacity:0.4}
        ::-webkit-scrollbar{width:3px}::-webkit-scrollbar-thumb{background:${T.border.default};border-radius:3px}
      `}</style>
